...
import { Baby, ArrowRight, TriangleAlert, Utensils } from "lucide-react";
  ...
  const fases = [
    {
      ...
      tag: "Fase 1",
      meses: "6 meses",
      titulo: "Início · purês e papas",
      cor: "from-sky-500 to-sky-400",
      corSoft: "text-sky-600 bg-sky-50",
      textura: "Consistência lisa e bem amassada",
      intro: "As primeiras colheradas. Um alimento por vez para observar reações e o paladar se acostumar.",
      dica: "Sem sal e sem açúcar no primeiro ano. Água só nas refeições, no copinho.",
      receitas: inicio,
    },
    {
      id: "amassados",
      ...
      <div className="space-y-6 px-4 py-4">
        ...
        <div className="flex items-start gap-3 rounded-2xl border border-amber-200/70 bg-amber-50 px-4 py-3 text-[13px] text-amber-800">
          ...
          <span>
            ...
            após os 3 anos; e sempre acompanhe a refeição de perto.
          </span>
        </div>
