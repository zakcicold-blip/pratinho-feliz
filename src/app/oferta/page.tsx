    ...
    <main className="flex-1 overflow-x-hidden bg-[#fdfaf6]">
        ...
        <div className="relative mx-auto grid w-full max-w-5xl items-center gap-10 px-6 py-14 md:grid-cols-2 md:py-20">
          <div className="text-center md:text-left">
            ...
            <p className="mt-4 text-lg text-stone-600">
              Pague uma vez e destrave o app na hora: 30 dias de refeições pela idade da criança,
              nutrição de verdade e a lista de compras pronta. Sem cozinhar no improviso.
            </p>
      ...
      <section id="planos" className="mx-auto w-full max-w-5xl scroll-mt-20 px-6 py-14">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-stone-500">Acesso liberado assim que o pagamento for confirmado.</p>
        </div>
        ...
        <p className="mt-8 text-center text-xs text-stone-400">
          ...
          <Link href="/cadastro" className="font-semibold text-orange-600 hover:underline">Comece com 7 dias grátis</Link>.
        </p>
      </section>
